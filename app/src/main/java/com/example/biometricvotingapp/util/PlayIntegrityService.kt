...
class PlayIntegrityService @Inject constructor(
     ...
     * In a production system with backend verification, this nonce might be
     * provided by or bound to a server-side challenge.
     * For client-side only token generation, a strong random nonce is sufficient.
     */
